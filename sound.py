...
def initialize_sounds(self):
    ...
    for i in range(4):
        sound = QSoundEffect()
        sound.setSource(QUrl.fromLocalFile(f"sound/pick{i}.wav"))
    ...
    self.meh_sound.setSource(QUrl.fromLocalFile("sound/meh.wav"))
    self.meh_sound.setVolume(self.sound_volume)
    self.poop_sound = QSoundEffect()
    self.poop_sound.setSource(QUrl.fromLocalFile("sound/poop.wav"))
    self.poop_sound.setVolume(self.sound_volume)
    self.eat_sound = QSoundEffect()
    self.eat_sound.setSource(QUrl.fromLocalFile("sound/eat.wav"))
